        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="reveal opacity-0 delay-200 space-y-5 text-lg leading-8 text-white/75">
              ...
              <p>
                This destruction is not primarily caused by climate change. It&apos;s driven by land use — overgrazing, uncontrolled agricultural expansion, invasive species. It can happen within a single generation. And it can be reversed.
              </p>
