...
export const metadata: Metadata = {
  title: 'Carbon Removals | SoilWatch',
  description: 'Portfolio of verified carbon removal projects developed and implemented by SoilWatch across East Africa.',
}
...
export default function CarbonRemovalsPage() {
  return (
    <main>
      <Navbar />
      ...
      <section className="section-shell overflow-hidden bg-soil-50 pb-16 pt-32">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="font-display text-5xl md:text-6xl font-bold uppercase text-soil-900 mb-5">
            ...
            <span className="gradient-text block">From the Ground Up</span>
          </h1>
      ...
      <section className="section-shell bg-white py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 text-center">
            <p className="mb-6 text-soil-500 text-sm">Interested in developing a project or purchasing credits?</p>
            <a
              href="/contact"
