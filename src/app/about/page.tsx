...
const values = [
  {
    ...
    description:
      'We ground our work in defensible science, robust methodologies, and measurable evidence across ecosystem restoration and carbon monitoring.',
  },
  {
    icon: ShieldCheck,
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="reveal opacity-0 delay-200 mt-7 max-w-3xl text-lg leading-8 text-soil-600">
                SoilWatch is a Helsinki-based business with offices in Nairobi and Brussels, providing remote sensing, nature-based solutions, and sustainable land use practices and capacity building with a particular focus on Africa, Latin America and developing countries.
              </p>
              <p className="reveal opacity-0 delay-300 mt-5 max-w-3xl text-lg leading-8 text-soil-600">
                Our expertise in ecosystem restoration, sustainable pastoralism, regenerative agriculture, agroforestry, soil carbon, and above-ground biomass monitoring, reporting and verification helps us create solutions that support local communities and meet the most rigorous standards of the carbon markets.
              </p>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div>
              ...
              <h2 className="reveal opacity-0 delay-100 mt-6 font-display text-4xl font-bold uppercase text-soil-900 md:text-5xl">
                Sustainable Land Use Is Key To A Better Future
              </h2>
              <div className="reveal opacity-0 delay-200 mt-6 space-y-5 text-lg leading-8 text-soil-600">
                <p>
                  At SoilWatch, we believe that sustainable land use is key to a better future for our planet. We combine the latest remote sensing technologies with nature-based solutions to provide practical, effective strategies for sustainable land use.
                </p>
                <p>
                  Our team of experts has extensive experience in the region and is committed to supporting sustainable practices that benefit local communities and the environment.
                </p>
              </div>
            </div>
          </div>
